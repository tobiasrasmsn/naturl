...
const MagicInput: React.FC<MagicInputProps> = ({ className, ...props }) => {
    ...
    return (
        <div className='relative w-full h-[52px] overflow-hidden rounded-md p-[1px]'>
            {isFocused && (
            ...
            <input
                {...props}
                className={`
          relative w-full h-full hover:bg-zinc-900/95 rounded-md bg-zinc-900/75 focus:bg-zinc-900/95 px-3 py-1 
          text-base text-white backdrop-blur-xl
